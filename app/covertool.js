...
const L = {
  ar: {
    ...
    note:
      "كل الحساب يتم داخل هاتفك. لا ترفع صورتك لاي خادم.",

    btype:
      "نوع الكتاب (يضبط المقاس تلقائيا)",
    ...
    ltr:
      "انجليزي (يسار الى يمين)",

    rtlL:
      "عربي (يمين الى يسار)",

    bleed:
      "المحتوى الداخلي فيه نزيف",

    guides:
      "إظهار الخطوط الإرشادية",
    ...
    good:
      "ممتازة وجاهزة للطباعة",

    warn:
      "قريبة لكن أقل من المطلوب",

    bad:
      "منخفضة جدا وستظهر مشوشة",

    none:
      "لم ترفع صورة بعد",

    fileTypes:
      "يمكنك رفع PDF أو JPG أو PNG",

    pdfLoaded:
      "تم تحميل PDF واستخدام الصفحة الأولى في المعاينة.",

    pdfReading:
      "جاري قراءة ملف PDF...",

    badFile:
      "الملف غير مدعوم. اختر PDF أو JPG أو PNG.",

    fileReadFail:
      "تعذر قراءة الملف. حاول بملف آخر.",
    ...
    okFix:
      "تم الاصلاح. الابعاد الان مطابقة تماما لمتطلبات امازون.",
    ...
    spineNo:
      "نص الكعب غير مسموح (أقل من 79 صفحة)",
  ...
  en: {
    ...
    note:
      "All math runs on your device. Your image is never uploaded.",

    btype:
      "Book type (sets the size for you)",
    ...
    warn:
      "Close but below target",

    bad:
      "Too low, will print blurry",

    none:
      "No image uploaded yet",

    fileTypes:
      "You can upload PDF, JPG or PNG",

    pdfLoaded:
      "PDF loaded. The first page is used in the preview.",

    pdfReading:
      "Reading PDF...",

    badFile:
      "Unsupported file. Choose PDF, JPG or PNG.",
    ...
    okFix:
      "Fixed. Dimensions now match Amazon exactly.",
    ...
    spineNo:
      "Spine text not allowed (under 79 pages)",
...
export default function CoverTool({
  ...
  const imageCheck = src
    ? checkImage(
        dim.w,
        dim.h,
        coverDimensions.widthPx,
        coverDimensions.heightPx
      )
    : {
        level: "none",
        ratio: 0,
  ...
  function paint(
    ...
    const width =
      coverDimensions.widthIn *
      scale;

    const height =
      coverDimensions.heightIn *
      scale;
    ...
    >
      ...
      <div className="grid">
        ...
        <div className="kpi">
          <b>
            {
              interiorDimensions.widthIn
            }{" "}
            x{" "}
            {
              interiorDimensions.heightIn
            }
          </b>
