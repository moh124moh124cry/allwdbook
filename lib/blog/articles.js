...
export const BLOG_ARTICLES = [
  {
    ...
    ar: {
      ...
      description:
        "القصة وراء إنشاء AllWDbook، والمشكلة العملية التي دفعت إلى بناء منصة تجمع أدوات يحتاجها ناشرو الكتب والمنت[...]"
    },
    en: {
...

  {
    ...
    ar: {
      ...
      description:
        "نظرة عملية على المراحل الأولى لبناء AllWDbook، من تحديد المشكلة إلى تحويل الفكرة إلى منصة تعمل فعليًا على ا[...]"
    },
    en: {
...

  {
    ...
    ar: {
      ...
      description:
        "كيف تم اختيار الطابع الأسود والبحري والبرتقالي وبناء هوية بصرية متناسقة مع طبيعة أدوات AllWDbook وتجربة ال[...]"
    },
    en: {
...

  {
    ...
    ar: {
      ...
      description:
        "دراسة تقنية حقيقية لمشكلة FOUC التي ظهرت عند تحميل الصفحة، وكيف أدى نقل CSS من styled-jsx إلى ملف مستقل إلى حله�[...]"
    },
    en: {
...

  {
    ...
    ar: {
      ...
      description:
        "لماذا اختير نظام AWD-KEY بدل فرض التسجيل بالبريد وكلمة المرور، وكيف يمكن للمستخدم استعادة الوصول على جها�[...]"
    },
    en: {
...

  {
    ...
    ar: {
      ...
      description:
        "تجربة حقيقية في البحث عن بوابة الدفع المناسبة لـAllWDbook، من Lemon Squeezy وتجميد المدفوعات إلى تجربة Paddle ثم ال�[...]"
    },
    en: {
      title:
...

  {
    ...
    ar: {
      ...
      description:
        "خطة تحريرية وعملية لاستثمار الفترة الأولى بعد الإطلاق في تحسين المنصة وبناء محتوى أصلي قبل التوسع في �[...]"
    },
    en: {
...

  {
    ...
    ar: {
      ...
      description:
        "خطوات عملية للانتقال من فكرة كتاب أولية إلى مجموعة كلمات مفتاحية منظمة يمكن تقييمها واستخدامها في مشر[...]"
    },
    en: {
...

  {
    ...
    ar: {
      ...
      description:
        "تجربة عملية توضح كيف يمكن تضييق موضوع واسع تدريجيًا حتى الوصول إلى Micro Niche أكثر تحديدًا وقابلية للدراس[...]"
    },
    en: {
...

  {
    ...
    ar: {
      ...
      description:
        "شرح قرار اعتماد نطاق www كعنوان رسمي واحد للموقع، ودور إعادة التوجيه في منع تعدد النسخ المتاحة من نفس ال[...]"
    },
    en: {
...

  {
    ...
    ar: {
      ...
      description:
        "تحسين الأداء من خلال معالجة طريقة تحميل الأنماط بدل تغيير منطق الأدوات أو المساس بتجربة الدفع والاستخ[...]"
    },
    en: {
...

  {
    ...
    ar: {
      ...
      description:
        "منهج تحريري يعتمد على التجارب والصور والنتائج الحقيقية بدل نشر مقالات متشابهة لا تضيف قيمة جديدة للقا[...]"
    },
    en: {
...

  {
    ...
    ar: {
      ...
      description:
        "كيف يمكن الاستعداد لتحقيق الدخل عبر التركيز أولًا على جودة الموقع والمحتوى وتجربة المستخدم بدل بناء ا[...]"
    },
    en: {
...

  {
    ...
    ar: {
      ...
      description:
        "طريقة عملية تبدأ بالمشكلة الفعلية للمستخدم وتنتهي بفكرة منتج رقمي محددة بدل البدء بفكرة عامة تبحث عن �[...]"
    },
    en: {
...

  {
    ...
    ar: {
      ...
      description:
        "تجربة عملية في إدارة ملفات المشروع عبر GitHub ونشر التحديثات على Vercel مع تقليل التغييرات الواسعة والمخاطر[...]"
    },
    en: {
...

  {
    ...
    ar: {
      ...
      description:
        "كيف يؤثر الاستخدام الفعلي للهاتف في قرارات التصميم والتنقل وحجم العناصر وترتيب المعلومات داخل منصة أ�[...]"
    },
    en: {
...

  {
    ...
    ar: {
      ...
      description:
        "كيف يمكن الموازنة بين قيمة الأداة وسهولة الدخول إليها والاشتراك الشهري والخطط الأطول عند تسعير منتج ر[...]"
    },
    en: {
...

  {
    ...
    ar: {
      ...
      description:
        "منهج عملي لعزل السبب الحقيقي للمشكلة قبل تعديل الملفات، مع الاستفادة من تجربة إصلاح مشكلة الت[...]"
    },
    en: {
...

  {
    ...
    ar: {
      ...
      description:
        "الإطلاق ليس نهاية بناء المنتج؛ بل بداية دورة من القياس والملاحظة والتحسين واتخاذ قرارات مبنية على الا[...]"
    },
    en: {
...
export const getPublishedBlogArticles = () =>
  BLOG_ARTICLES.map((article) => ({
    ...article,
    published: true,
    publishDate: article.publishDate || "2026-08-22",
  }));
...
export const getLocalizedBlogArticle = (article, lang = "en") => {
  if (!article) {
    return null;
  }
...
export const getBlogArticleUrl = (article, lang = "en") => {
  if (!article?.slug) {
    return null;
  }
