...
export const BLOG_ARTICLES = [
...

  {
    ...
    toolPath: null,
    ar: {
      title: "كيف حسّنا Core Web Vitals لمدونة AllWDbook بـ Next.js",
      shortTitle: "تحسين Core Web Vitals",
      description:
        "خطوات عملية لتحسين LCP وCLS وFID في مدونة Next.js، مع أمثلة حقيقية من مشروع AllWDbook وكيف أثرت على ترتيب الموقع في البحث.",
    },
    en: {
      title: "How We Improved Core Web Vitals for the AllWDbook Next.js Blog",
      shortTitle: "Improving Core Web Vitals",
      description:
        "Practical steps to improve LCP, CLS, and FID on a Next.js blog, with real examples from the AllWDbook project and their impact on search rankings.",
    },
  },

  {
    id: "creator-pricing-digital-product",
    slug: "how-to-price-your-digital-product",
    category: "creator",
    series: null,
    published: true,
    featured: true,
    ...
    toolPath: null,
    ar: {
      title: "كيف تسعّر منتجك الرقمي؟ دروس من تجربة AllWDbook",
      shortTitle: "تسعير المنتج الرقمي",
      description:
        "دليل عملي لاختيار سعر مناسب للمنتج الرقمي، بناءً على تجربة AllWDbook في اختبار نقاط السعر المختلفة ودراسة سلوك المشترين.",
    },
    en: {
      title: "How to Price Your Digital Product: Lessons from AllWDbook",
      shortTitle: "Pricing Your Digital Product",
      description:
        "A practical guide to choosing the right price for your digital product, based on AllWDbook's experience testing different price points and studying buyer behavior.",
    },
  },
];
