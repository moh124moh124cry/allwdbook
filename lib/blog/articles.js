...
export const BLOG_ARTICLES = [
...

  {
    ...
    heroImage: "/blog/allwdbook/journey.webp",
    toolPath: null,
    ar: {
...

  {
    ...
    heroImage: "/blog/allwdbook/identity.webp",
    toolPath: null,
    ar: {
...

  {
    ...
    heroImage: "/blog/allwdbook/flash.webp",
    toolPath: null,
    ar: {
...

  {
    ...
    heroImage: "/blog/allwdbook/tools.webp",
...

  {
    ...
    heroImage: "/blog/allwdbook/from-broad-idea-to-micro-niche-1.webp",
  ...
  {
    id: "seo-technical-audit-playbook",
    ...
    heroImage: "/blog/articles/seo-technical-audit-hero.svg",
    toolPath: null,
    ar: {
      title: "دليل عملي: SEO Technical Audit لمواقع المحتوى خطوة بخطوة",
      shortTitle: "SEO Technical Audit عملي",
      description:
        "إطار عملي لمراجعة الفهرسة والسرعة والبنية الداخلية والأخطاء التقنية قبل توسيع المحتوى.",
    },
    en: {
      title: "A Practical SEO Technical Audit Playbook for Content Sites",
      shortTitle: "Practical SEO Audit Playbook",
      description:
        "A practical framework to review indexing, speed, internal structure, and technical blockers before scaling content.",
    },
  },

  {
    id: "creator-mobile-first-workflow",
    ...
    heroImage: "/blog/articles/creator-mobile-workflow-hero.svg",
    toolPath: null,
    ar: {
      title: "كيف نبني Workflow فعّال لتطوير المنتجات الرقمية بطريقة Mobile-First",
      shortTitle: "Workflow Mobile-First",
      description:
        "خطوات عملية لتحويل الفكرة إلى خطة تنفيذ مركزة على تجربة الهاتف وسرعة التكرار.",
    },
    en: {
      title: "How to Build an Effective Mobile-First Workflow for Digital Products",
      shortTitle: "Mobile-First Product Workflow",
      description:
        "Practical steps to move from idea to execution with a mobile-first UX and fast iteration rhythm.",
    },
  },
];
