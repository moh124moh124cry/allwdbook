...
export const BLOG_ARTICLES = [
...

  {
    ...
    ar: {
      ...
      description:
        "خطة تحريرية وعملية لاستثمار الفترة الأولى بعد الإطلاق في تحسين المنصة وبناء محتوى أصلي قبل التوسع في التسويق.",
    },
    en: {
...

  {
    ...
    ar: {
      ...
      description:
        "كيف يمكن الاستعداد لتحقيق الدخل عبر التركيز أولًا على جودة الموقع والمحتوى وتجربة المستخدم بدل بناء كل شيء حول الإعلانات.",
    },
    en: {
...

  {
    ...
    ar: {
      ...
      description:
        "تجربة عملية في إدارة ملفات المشروع عبر GitHub ونشر التحديثات على Vercel مع تقليل التغييرات الواسعة والمخاطر المرتبطة.",
    },
    en: {
...

  {
    ...
    ar: {
      ...
      description:
        "كيف يؤثر الاستخدام الفعلي للهاتف في قرارات التصميم والتنقل وحجم العناصر وترتيب المعلومات داخل منصة أدوات الناشر.",
    },
    en: {
...

  {
    ...
    ar: {
      ...
      description:
        "منهج عملي لعزل السبب الحقيقي للمشكلة التقنية قبل تعديل الملفات، مع الاستفادة من تجربة إصلاح مشكلة التحميل.",
    },
    en: {
