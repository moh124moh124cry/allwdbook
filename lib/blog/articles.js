...
export const BLOG_ARTICLES = [
...

  {
    ...
    en: {
      ...
      shortTitle:
        "How We Fixed the Loading Flash",
      description:
...

  {
    ...
    en: {
      ...
      shortTitle:
        "Access Without a Forced Account",
      description:
