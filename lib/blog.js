...
export const BLOG_CATEGORIES = Object.freeze([
  Object.freeze({
    ...
    slug: "allwdbook",
    icon: "🚀",
    image: "/blog/allwdbook/hero.webp",
    ar: Object.freeze({
  ...
  Object.freeze({
    ...
    slug: "kdp",
    icon: "📚",
    image: "/blog/allwdbook/kdp-keyword-research-hero.webp",
    ar: Object.freeze({
  ...
  Object.freeze({
    ...
    slug: "seo",
    icon: "📈",
    image: "/blog/categories/seo-hero.svg",
    ar: Object.freeze({
  ...
  Object.freeze({
    ...
    slug: "creator",
    icon: "🛠️",
    image: "/blog/categories/creator-hero.svg",
    ar: Object.freeze({
...
export function getBlogCategoryUrl(
  ...
  const safeLang = normalizeBlogLang(lang);
  const safeSlug = String(categorySlug || "")
    .trim()
    .replace(/^\/+|\/+$/g, "");
