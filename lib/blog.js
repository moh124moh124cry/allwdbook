...
export const BLOG_CATEGORIES = Object.freeze([
  Object.freeze({
    ...
    slug: "allwdbook",
    icon: "🚀",
    heroImage: "/blog/categories/allwdbook-hero.webp",
    ar: Object.freeze({
  ...
  Object.freeze({
    ...
    slug: "kdp",
    icon: "📚",
    heroImage: "/blog/categories/kdp-hero.webp",
    ar: Object.freeze({
  ...
  Object.freeze({
    ...
    slug: "seo",
    icon: "📈",
    heroImage: "/blog/categories/seo-hero.webp",
    ar: Object.freeze({
  ...
  Object.freeze({
    ...
    slug: "creator",
    icon: "🛠️",
    heroImage: "/blog/categories/creator-hero.webp",
    ar: Object.freeze({
...
export function getBlogCategoryUrl(
  ...
  return `/${safeLang}/blog/category/${safeCategorySlug}`;
}
